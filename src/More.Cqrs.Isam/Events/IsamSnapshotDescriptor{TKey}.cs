...
namespace More.Domain.Events
{
    ...
    /// <summary>
    /// Represents a descriptor for an aggregate snapshot stored in an ISAM database.
    /// </summary>
    /// <typeparam name="TKey">The type of aggregate key.</typeparam>
    public class IsamSnapshotDescriptor<TKey> : IDisposable
    {
        bool disposed;

        /// <summary>
        /// Finalizes an instance of the <see cref="IsamSnapshotDescriptor{TKey}"/> class.
        /// </summary>
        ~IsamSnapshotDescriptor() => Dispose( false );
        ...
        /// <summary>
        /// Releases the managed and, optionally, the unmanaged resources used by the <see cref="IsamSnapshotDescriptor{TKey}"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Releases the managed resources used by the <see cref="IsamSnapshotDescriptor{TKey}"/> class.
        /// </summary>
        public void Dispose()
        {
            Dispose( true );
