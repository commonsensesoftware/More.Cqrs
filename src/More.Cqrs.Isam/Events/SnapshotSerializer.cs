...
namespace More.Domain.Events
{
    ...
    sealed class SnapshotSerializer
    {
        ...
        readonly IsamEventStoreConfiguration configuration;
        ...
        internal SnapshotSerializer( Type keyType, IsamEventStoreConfiguration configuration )
        {
        ...
        internal IEnumerable<IEvent> Deserialize<TKey>( IEnumerable<IEvent> events, IsamSnapshotDescriptor<TKey> snapshotDescriptor )
        {
...
#pragma warning restore CA1812
        {
            ...
            readonly IIsamMessageSerializer<TSnapshot> serializer;

            public AbstractDeserializerFactory( IsamEventStoreConfiguration configuration ) => serializer = configuration.NewMessageSerializer<TSnapshot>();
