...
namespace More.Domain.Messaging
{
    ...
    /// <summary>
    /// Represents an ISAM database message serializer that uses the JSON format with compression.
    /// </summary>
    ...
    public class CompressedIsamJsonMessageSerializer<TMessage> : IsamJsonMessageSerializer<TMessage> where TMessage : class
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompressedIsamJsonMessageSerializer{TMessage}"/> class.
        /// </summary>
        ...
        public CompressedIsamJsonMessageSerializer( IMessageTypeResolver messageTypeResolver, JsonSerializer jsonSerializer )
