...
namespace More.Domain.Messaging
{
    ...
    /// <summary>
    /// Represents an ISAM database message serializer that uses the JSON format.
    /// </summary>
    /// <typeparam name="TMessage">The type of message to serialize and deserialize.</typeparam>
    public class IsamJsonMessageSerializer<TMessage> : IIsamMessageSerializer<TMessage> where TMessage : class
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IsamJsonMessageSerializer{TMessage}"/> class.
        /// </summary>
        ...
        public IsamJsonMessageSerializer( IMessageTypeResolver messageTypeResolver, JsonSerializer jsonSerializer )
        {
