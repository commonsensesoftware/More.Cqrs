...
namespace More.Domain.Messaging
{
    ...
    /// <summary>
    /// Represent an item in an ISAM database message queue.
    /// </summary>
    public class IsamMessageQueueItem : IDisposable
    {
        bool disposed;

        /// <summary>
        /// Finalizes an instance of the <see cref="IsamMessageQueueItem"/> class.
        /// </summary>
        ~IsamMessageQueueItem() => Dispose( false );
        ...
        /// </summary>
        /// <value>The <see cref="IsamTransaction">database transaction</see> associated with the item.</value>
        ...
        public IsamTransaction Transaction { get; set; }

        /// <summary>
        /// Releases the managed and, optionally, the unmanaged resources used by the <see cref="IsamMessageQueueItem"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Releases the managed resources used by the <see cref="IsamMessageQueueItem"/> class.
        /// </summary>
        public void Dispose()
        {
            Dispose( true );
