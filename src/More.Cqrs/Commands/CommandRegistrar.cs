...
namespace More.Domain.Commands
{
    ...
    public class CommandRegistrar : ICommandHandlerRegistrar
    {
        ...
        public CommandRegistrar( IServiceProvider serviceProvider ) => this.serviceProvider = serviceProvider;
        ...
        public virtual void Register<TCommand>( Func<IHandleCommand<TCommand>> handlerActivator ) where TCommand : notnull, ICommand =>
        ...
        public virtual IHandleCommand<TCommand> ResolveFor<TCommand>( TCommand command ) where TCommand : notnull, ICommand
        {
