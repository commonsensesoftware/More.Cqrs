...
namespace More.Domain
{
    ...
    public static class IMessageContextExtensions
    {
        ...
        public static Task Send( this IMessageContext context, ICommand command ) => context.Send( command, new SendOptions() );
        ...
        /// <returns>A <see cref="Task">task</see> representing the asynchronous operation.</returns>
        public static Task Send( this IMessageContext context, IEnumerable<ICommand> commands ) => context.Send( commands, new SendOptions() );
        ...
        public static Task Send( this IMessageContext context, IEnumerable<ICommand> commands, SendOptions options ) =>
            Task.WhenAll( commands.Select( command => context.Send( command, options ) ) );
        ...
        /// <returns>A <see cref="Task">task</see> representing the asynchronous operation.</returns>
        public static Task Publish( this IMessageContext context, IEvent @event ) => context.Publish( @event, new PublishOptions() );
        ...
        public static Task Publish( this IMessageContext context, IEnumerable<IEvent> events, PublishOptions options ) =>
            Task.WhenAll( events.Select( @event => context.Publish( @event, options ) ) );
    }
}