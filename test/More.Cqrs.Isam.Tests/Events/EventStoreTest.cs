namespace More.Domain.Events
{
    ...
    public class EventStoreTest : DatabaseTest<EventStoreFixture<Guid>>
    {
        ...
        public EventStoreTest( EventStoreFixture<Guid> setup )
            : base( setup ) => EventStore = new IsamEventStore<Guid>( setup.Persistence, setup.Configuration );

        IsamEventStore<Guid> EventStore { get; }
    }
}