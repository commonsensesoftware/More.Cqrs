namespace More.Domain.Messaging
{
    ...
    {   
        ...
        {
            MessageSender = new IsamMessageSender( setup.Configuration );
            MessageReceiver = new IsamMessageReceiver( setup.Configuration );
        }

        IsamMessageSender MessageSender { get; }

        IsamMessageReceiver MessageReceiver { get; }
